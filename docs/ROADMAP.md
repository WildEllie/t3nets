...
- [x] Split `agent/practices/registry.py` (643 lines) → `registry` + `installer` + `deployer` + `assets`
      ↳ ✅ registry.py 188L (orchestrator), installer.py 266L, deployer.py 197L, assets.py 86L
